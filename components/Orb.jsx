...
export default function Orb({
  ...
  // Use useCallback to memoize the hexToVec3 function
  const hexToVec3 = useCallback((color) => {
    if (color.startsWith('#')) {
  ...
  }, [hue, hoverIntensity, rotateOnHover, forceHoverState, backgroundColor, hexToVec3]);
